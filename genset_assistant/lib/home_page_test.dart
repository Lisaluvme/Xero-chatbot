...
class TestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Contact Page Test'),
        ),
...
class _ContactPageState extends State<ContactPage> {
  ...
  Map<String, String> get _currentContact => Map<String, String>.from(_contactInfo[_currentContactType]!);
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'We\'re here to help with your generator needs',
                                style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Phone: ${_currentContact['phone']}'),
                    const SizedBox(height: 8),
                    Text('Email: ${_currentContact['email']}'),
                    const SizedBox(height: 8),
                    Text('Note: ${_currentContact['note']}'),
                  ],
                ),
              ),
            ],
